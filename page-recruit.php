...
<!-- kv -->
<section class="kv">
  <div class="kv-img"> <img src="<?php echo get_template_directory_uri(); ?>/assets/img/recruit/kv_recruit-pc.jpg" alt="キービジュアル画像"> </div>
  <div class="kv-cnt">
...
<section class="recruit-sec">
  ...
  <div class="recruit-bnr-cnt">
    ...
    <div class="recruit-bnr-item inner-800"> <a href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/recruit/mynav_bnr-2026.png" alt=""></a> <a href="#"><img src="a<?php echo get_template_directory_uri(); ?>/assets/img/recruit/mynav_bnr-2027.png" alt=""></a> </div>
  </div>
</section>
