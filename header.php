...
<header id="header">
  <div class="wrap">
    ...
    <nav id="global-nav">
      <ul id="menu">
        <li class="<?php if (is_front_page()) echo 'current'; ?>"> <a href="<?php echo home_url(); ?>">TOP</a> </li>
        <li class="<?php if (is_page('company')) echo 'current'; ?>"> <a href="<?php echo home_url(); ?>/company/">会社案内</a> </li>
        <li class="<?php if (is_page('business')) echo 'current'; ?>"> <a href="<?php echo home_url(); ?>/business/">事業案内</a> </li>
        <li class="<?php if( is_post_type_archive('post') ) echo 'current'; ?>"> <a href="<?php echo home_url(); ?>/news">ニュース</a> </li>
		<li class="<?php if (is_page(['contact', 'c-corporation', 'c-recruit'])) echo 'current'; ?>">
